...
For release `v0.2.3`, download the artifact for your platform plus the common checksum manifest:
...
A fresh `0.2.3` bundle on every platform reports version `0.2.3` and:
