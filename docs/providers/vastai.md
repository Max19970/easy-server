...
The first-party Vast.ai integration is maintained and released independently from EasyServer.

- Repository and provider-owned documentation: https://github.com/Max19970/easy-server-plugin-vastai
- npm package: `@easyai101/easyserver-plugin-vastai`
