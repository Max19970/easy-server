# Плагин провайдера Intelion.cloud

First-party интеграция Intelion.cloud поддерживается и выпускается независимо от EasyServer.

- Репозиторий и документация провайдера: https://github.com/Max19970/easy-server-plugin-intelion
- npm-пакет: `@easyai101/easyserver-plugin-intelion`
